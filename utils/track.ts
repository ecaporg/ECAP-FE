...
export const getTrackCalendarDays = (calendar: TrackCalendar) => {
...
const getTrackCalendarDaysWithWeekends = (calendar: TrackCalendar) => {
  const acc: Record<string, TrackCalendarDay> = {};
